...
export function FinalCTA() {
  ...
  return (
    <Section
      id="final-cta"
      className="relative overflow-hidden bg-gradient-to-br from-primary-light via-primary to-primary-dark py-20 sm:py-24 lg:py-28"
    >
      <div
        aria-hidden="true"
        ...
        >
          <div className="flex flex-col items-center gap-5">
            ...
            <p className="text-balance text-white/90 sm:text-lg">
              ...
              post-surgery assistance, or home healthcare guidance, our team
              is here to help.
            </p>
            <p className="text-balance text-white/90 sm:text-lg">
          ...
          <div className="flex w-full flex-col items-center gap-4 border-t border-white/15 pt-8 text-sm text-white/85 sm:flex-row sm:flex-wrap sm:justify-center sm:gap-x-8 sm:gap-y-3">
            <a
              href={phoneHref}
              className="focus-visible:ring-white/70 focus-visible:outline-white flex items-center gap-2 rounded-md outline-none transition-colors hover:text-white focus-visible:ring-3"
            >
